    ...
    <section id="contacto" className="page-section relative overflow-hidden bg-axon-dark text-white">
      ...
      <div className="container-shell relative z-10 grid items-start gap-11 lg:grid-cols-[0.88fr_1.12fr]">
        <div className="reveal">
          ...
          <h2 className="font-display text-[clamp(2.125rem,5vw,3.125rem)] font-extrabold leading-[1.08] text-white">Agenda un Discovery y recibe una ruta clara en 48 horas.</h2>
          <p className="mt-5 max-w-[540px] text-base leading-8 text-[#A8B2C4]">
            En 30 minutos identificamos oportunidades, fricciones y prioridades. Después te entregamos una ruta de implementación con alcance, tiempos e inversión.
          </p>
          ...
          <div className="mt-7 flex flex-wrap gap-2.5" aria-label="Señales de confianza">
            {["Propuesta ejecutiva", "Tracking incluido", "Enfoque B2B"].map((item) => (
